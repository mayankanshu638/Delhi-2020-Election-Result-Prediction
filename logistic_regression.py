...
test_df.to_csv(r"C:\Users\hp\Desktop\Election\Datewise\Dataset\prediction_of_logistic.csv",index = False)

y_test=list()
predict=list()

with open(r"C:\Users\hp\Desktop\Election\Datewise\Dataset\prediction_of_logistic.csv","r",encoding='utf-8') as read_obj :
